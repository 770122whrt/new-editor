...
| [tools](tools.md) | Editor tools structure in `packages/editor/src/components/tools/` |
| [viewer-isolation](viewer-isolation.md) | Keeping `@pascal-app/viewer` editor-agnostic |
| [selection-managers](selection-managers.md) | Two-layer selection, viewer/editor events, and outliner rules |
| [scene-registry](scene-registry.md) | Global node ID to Object3D map and `useRegistry` |
...
| [events](events.md) | Typed event bus for emitting and listening to node and grid events |
